<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="区域搜索" prop="regionId">
        <el-select v-model="queryParams.regionId" placeholder="请选择区域" clearable>
          <el-option v-for="item in regionList" :key="item.id" :label="item.regionName" :value="parseInt(item.id)">
          </el-option>
        </el-select>
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <right-toolbar v-model:showSearch="showSearch" @queryTable="handleQueryTable"></right-toolbar>
    </el-row>
    ...
    <!-- 点位详情对话框 -->
    <el-dialog :title="title" v-model="openNodeInfo" width="600px" append-to-body>
      <el-table :data="vmList">
        ...
        <el-table-column label="最后一次供货时间" align="center" prop="lastSupplyTime" width="180px">
          <template #default="scope">
