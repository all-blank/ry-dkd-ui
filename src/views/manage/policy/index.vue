<template>
  <div class="app-container">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" @click="getPolicyInfo(scope.row)"
            v-hasPermi="['manage:policy:list', 'manage:vm:list']">查看详情</el-button>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="policyRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="策略方案" prop="discount">
          <el-input-number v-model="form.discount" :min="1" :max="100" :precision="0" style="width: 200px;"
            placeholder="请输入策略方案" />
        </el-form-item>
      </el-form>
      <template #footer>
    ...
    <!-- 查看详情对话框 -->
    <el-dialog :title="title" v-model="openPolicyInfo" width="600px" append-to-body>
      <el-form ref="policyRef" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="策略名称">
          <el-input v-model="form.policyName" placeholder="请输入策略名称" disabled />
        </el-form-item>
        <el-form-item label="包含设备:" style="display: block; margin-left: 6px;">
          <el-table :data="vmList" style="margin: 20px 0 0 30px;">
...
/** 查看详情按钮操作 */
const openPolicyInfo = ref(false);
const vmList = ref([]);
