  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" v-model="open" width="550px" append-to-body>
      <el-form ref="vmTypeRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="货道数" required>
          <el-row :gutter="30">
            <el-col :span="12">
              <el-form-item prop="vmRow">
                <el-input-number v-model="form.vmRow" :min="1" :max="10" style="width: 180px;"
                  placeholder="请输入货道行" />&nbsp;行
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item prop="vmCol">
                <el-input-number v-model="form.vmCol" :min="1" :max="10" style="width: 180px;" placeholder=" 请输入货道列" />
                &nbsp;列
              </el-form-item>
            </el-col>
          </el-row>
        ...
        <el-form-item label="货道容量" prop="channelMaxCapacity">
          <el-input-number v-model="form.channelMaxCapacity" :mix="1" :max="10" style="width: 200px;"
            placeholder="请输入货道容量" />&nbsp;个
        </el-form-item>
